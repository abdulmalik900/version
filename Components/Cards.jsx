...
const Cards = () => {
 ...
 <section className="bg-gray-50 py-24"> 
  ...
  className="container mx-auto px-4"> 
    <div className="-mx-4 flex flex-wrap items-center mb-6"> 
      <div className="px-4 w-full md:w-10/12"> 
        <h2 className="font-medium mb-1 text-primary-500 text-xl pb-4">Our Top Available Cars</h2>
        <h3 className="capitalize font-bold mb-4 text-4xl text-gray-900">Cars for all your needs</h3>
  ...
  />
          ...
          <div className="p-6">
            <h4 className="font-bold mb-2 text-gray-900 text-xl"><a href="#" className="hover:text-gray-500">Mitsubishi Fuso Canter</a></h4>
            ...
            <div className="flex items-center justify-between">
              <div className="inline-flex items-center py-1 space-x-1">
                <span>4.7</span>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1.125em" height="1.125em" className="text-primary-500">
                  <g>
              ...
              <p className="font-bold text-gray-900">$40/day</p>
            </div>
          </div>                                 
        </div>                             
      </div>
  ...
  />
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <p className="font-bold text-gray-900">$65/day</p>
            </div>
          </div>                                 
        </div>                             
      </div>
  ...
  />
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <p className="font-bold text-gray-900">$55/day</p>
            </div>
          </div>                                 
        </div>                             
      </div>
  ...
  />
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <p className="font-bold text-gray-900">$75/day</p>
            </div>
          </div>                                 
        </div>                             
      </div>
  ...
  />
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <p className="font-bold text-gray-900">$90/day</p>
            </div>
          </div>                                 
        </div>                             
      </div>                         
    ...
    <div className="text-center">
      <a href="#" className="bg-primary-500 hover:bg-primary-600 inline-block px-6 py-2 text-white">View All Cars</a>
    </div>
  </div>                 
</section>
